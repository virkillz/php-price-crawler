                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="center" valign="top" class="textContent">
                                                                                    <img src="images/small/bg.jpg" alt="" style="max-width:500px;width:100%;display:block;"></img>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tr>
                                                                                            <td valign="top" class="textContent">
                                                                                                <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Congratulations!</h3>
                                                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Your CV and profile are selected as our candidate. Next step is to fill the written test which you can find in URL below using password. This test will only valid for 3 days. Any difficulties, please contact us.</div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                    <!-- // CONTENT TABLE -->
                                                        ...
                                                        <td align="center" valign="top">
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
                                                                <tr>
                                                                    ...
                                                                    <div>
                                                                    <p>Please use the link below to submit your written test answer:</p>
                                                                    <p><a href="http://umgmyanmar.com/question/hash/jkdhakhH67GJKjfkjGu7775GHJj">http://umgmyanmar.com/question/hash/jkdhakhH67GJKjfkjGu7775GHJj</a></p>
                                                                    <p>Please use following password: <b>Ghgd54Dw</b></p>
                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" valign="top" class="flexibleContainerBox">
                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:100%;">
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                <img src="images/small/img3.jpg" width="210" class="flexibleImage" style="max-width:100%;" alt="Text" title="Text" />
                                                                                ...
                                                                                <td align="right" valign="middle" class="flexibleContainerBox">
                                                                                    <table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:100%;">
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                <img src="images/small/img1.jpg" width="210" class="flexibleImage" style="max-width:100%;" alt="Text" title="Text" />
