                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Export scraping result</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Export Scraping Result</h3></div>
                                    <div class="panel-body">
                                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>export/scrapexportaction" method="post">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Product Keyword</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="keyword" placeholder="ie: huawei or samsung. leave empty to get all">
                                                </div>
                                            </div>
                                            <div class="form-group">
